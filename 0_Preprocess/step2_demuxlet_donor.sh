...
~/conda/anaconda3/envs/popscale/bin/popscle demuxlet --sam ./sequnecing.bam \  ##Multi-ome: input atac_gex bam was megered by atac_bam and gene_expression_bam. RNA-seq: Expression bam only 

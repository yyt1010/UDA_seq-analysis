...
work_dir= '~/Kidney/RNA/results/Scissor2/impairment/I_M_EC_GC/EC_GC_only/SCENICplus1/SCENICplus'
...
nx_tables = create_nx_tables(
    ...
    subset_eRegulons = ['KLF12','SOX5_extended','SREBF2'],
    subset_regions = hvr,
    subset_genes = hvg,
...
G, pos, edge_tables, node_tables = create_nx_graph(nx_tables,
                   ...
                   color_edge_by = {'TF2R': {'variable' : 'TF', 'category_color' : {'KLF12': 'Orange', 'SOX5': 'Purple', 'SREBF2': 'Red'}},
                   ...
                   color_node_by = {'TF': {'variable': 'TF', 'category_color' : {'KLF12': 'Orange', 'SOX5': 'Purple', 'SREBF2': 'Red'}},
                                    'Gene': {'variable': 'ACC_Cluster_Log2FC_cluster_2', 'continuous_color' : 'bwr'},
                                    'Region': {'variable': 'ACC_Cluster_Log2FC_cluster_2', 'continuous_color' : 'viridis'}},
                   transparency_node_by =  {'Region': {'variable' : 'ACC_Cluster_Log2FC_cluster_2', 'min_alpha': 0.1},
                                    'Gene': {'variable' : 'ACC_Cluster_Log2FC_cluster_2', 'min_alpha': 0.1}},
